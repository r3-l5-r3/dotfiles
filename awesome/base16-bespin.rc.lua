...
-- Register widget
vicious.register(netwidget, vicious.widgets.net, '<span color="#CC9393">▼ ${enp0s20f0u1u4 down_kb}</span> <span color="#7F9F7F">▲ ${enp0s20f0u1u4 up_kb}</span>', 3)
...
awful.rules.rules = {
    ...
    { rule_any = {type = { "normal", "dialog" }
      }, properties = { titlebars_enabled = false } -- TODO set off
    },

    -- Set Discord and Pidgin to always map on the tag named "♥ "
